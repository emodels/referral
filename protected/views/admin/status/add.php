...
<div style="float: left; width: 670px; padding-left: 10px">
    ...
    <h2 class="icon_search" style="padding-top: 12px"><?php echo $model->referralUser->company; ?> - Add Referral Status<span></span></h2>
    <div class="form">
    <?php
    ...
    <div>
        ...
        <div class="row">
            ...
            <div><?php echo CHtml::submitButton('Add Status', array('class' => 'button')); ?></div>
        </div>
    </div>
    <?php $this->endWidget(); ?>    
    </div>
