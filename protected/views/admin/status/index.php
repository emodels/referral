...
<div style="float: left; width: 670px; padding: 12px 0 0 10px">
    <div style="float: left"><a href="add/<?php echo Yii::app()->request->getQuery('id'); ?>" class="link_box"><img style="vertical-align: middle; text-decoration: none; padding-right: 5px" src="<?php echo Yii::app()->baseUrl; ?>/images/add.png">Add Status</a></div>
