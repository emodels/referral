...
<div style="border: solid 1px silver; width: 100%; padding: 10px; background-color: #f7f7f7; font-family: arial">
    ...
    <p>This is automated reminder to notify that you have not updated Status of Referral Entry record ID : <?php echo $entry_id; ?>, within last 7 days. <a href="<?php echo $link; ?>">Click here</a> to view and update Status and details.</p>
