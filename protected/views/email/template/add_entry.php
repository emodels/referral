...
<div style="border: solid 1px silver; width: 100%; padding: 10px; background-color: #f7f7f7; font-family: arial">
    ...
    <p><?php echo Yii::app()->user->site_name; ?> have added <b>NEW</b> Referral to <b><?php echo $company; ?></b> with ID : <?php echo $entry_id; ?> For your reference <a href="<?php echo $link; ?>">Click here</a> to view details.</p>
