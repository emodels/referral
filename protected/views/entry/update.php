...
<div style="float: left; width: 82%; padding-left: 10px">
    ...
    <div>
        <div class="row">
            ...
            <div>
                <?php echo $form->dropDownList($model, 'referrel_user',
                      ...
                      array('style'=>'width:204px','empty'=>'Select Partner', 'ajax' => array('type'=>'POST','url'=>CController::createUrl('ListStatus'),'update'=>'#Entry_status'), 'disabled'=> Yii::app()->user->user_type !== '0' ?'disabled' : '')); ?>
           </div>
        </div>
        <div class="row">
        ...
        <div class="row">
            ...
            <div><?php echo $form->dropDownList($model, 'status', $status, array('style'=>'width:204px','empty'=>'Select Status')); ?></div>
        </div>
        <div class="row">
            <div class="column">Priority</div>
            <div><?php echo $form->dropDownList($model, 'priority', array('0'=>'Low','1'=>'Medium','2'=>'High'), array('style'=>'width:204px','empty'=>'Select Priority')); ?></div>
        </div>
        <div class="row">
