...
<div><input type="button" value="Add New Receipt" class="button" onclick="javascript:window.document.location.replace('<?php echo Yii::app()->baseUrl ?>/receipts/add/prop_id/<?php echo $property->id; ?>')"></div>
<?php
